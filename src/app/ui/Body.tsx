...
export default function PortfolioBody() {
  return (
    <div id="about" className="bg-gradient-to-b bg-black to-gray-900 min-h-screen">
      <div className="min-h-screen bg-black text-white px-5 py-5 w-full">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10">
          ...
          {/* <div className="flex w-1/2 justify-center mt-10 lg:mt-0">
            <div className="relative w-[350px] sm:w-[400px] md:w-[450px] lg:w-[500px] h-[500px] sm:h-[550px] lg:h-[600px] rounded-lg overflow-hidden custom-photo-position">
              <Image src="/hero.png" alt="Pani Maulana" width={1600} height={2000} className="img-home-hero rounded-lg object-cover absolute py-10 px-5" />
            </div>
          </div> */}
        </div>
      </div>
