...
export default function PortfolioBody() {
  return (
    <div id="about" className="bg-gradient-to-b bg-black to-gray-900 min-h-screen">
      ...
      <div className="w-full grid grid-cols-2 gap-4 mt-10 p-3 px-20">
        <div className="w-full h-full">
          <div className="group-text-home text-center lg:text-left px-12 mt-10 pt-14 z-10 relative">
            ...
            <h1 className="w-full text-white text-3xl text-[60px] font-bold lg:whitespace-nowrap mb-10">Pani Maulana Nurdwiyansah</h1>
            ...
            <Link href="https://www.instagram.com/p.maulana72" className="text-2xl">
            ...
            <Link href="https://wa.me/6289619260062" className="text-2xl">
            ...
            <Link href="https://www.linkedin.com/in/pani-maulana-nurdwiyansah-b93ab3251" className="text-2xl">
      ...
      <div className="img-content-hero-5">
          <div className="content-frame-img-4">
            <Image className="frame-img-4" src="/ux-design.png" width={1000} height={500} alt="Frame" />
          </div>
        </div>
    </div>
  );
