    ...
    <header className="w-full py-5 z-10 relative">
      <nav className="w-full bg-transparent backdrop-blur-md border-none hover:opacity-90 transition-all duration-300 z-10 relative">
        <ul className="flex justify-center items-center gap-8 text-sm font-medium py-1 z-10 relative">
          ...
          <li className="py-2 group">
            <Link href="/about" className="text-[#9C9C9C] text-[18px] font-inter font-medium scroll-smooth relative">
              ABOUT
              <span className="absolute left-0 -bottom-1 w-0 h-[2px] bg-[#605DFF] transition-all duration-300 group-hover:w-full"></span>
            </Link>
          </li>
          ...
          <li className="py-2 group">
            <Link href="/garage-two" className="text-[#9C9C9C] text-[18px] font-inter font-medium scroll-smooth relative">
              GARAGE
              <span className="absolute left-0 -bottom-1 w-0 h-[2px] bg-[#605DFF] transition-all duration-300 group-hover:w-full"></span>
            </Link>
          </li>
          <li className="py-2 group">
            <Link href="/resume" className="text-[#9C9C9C] text-[18px] font-inter font-medium scroll-smooth relative">
              RESUME
              <span className="absolute left-0 -bottom-1 w-0 h-[2px] bg-[#605DFF] transition-all duration-300 group-hover:w-full"></span>
            </Link>
          </li>
